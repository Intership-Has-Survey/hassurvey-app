...
<body>
    <div class="container">
        ...
        <table>
            <tr>
                <th>Nama Proyek</th>
                <td>: {{ $acara->project->nama_project }}</td>
            </tr>
            <tr>
                <th>Pemberi Tugas (Pihak Pertama)</th>
                <td>: {{ $acara->project->corporate?->nama ?? $acara->project->perorangan?->first()->nama }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>: {{ \Carbon\Carbon::parse($acara->project->mulai)->translatedFormat('d F Y') }}
                </td>
            </tr>
            <tr>
                <th>Tanggal Selesai Pekerjaan</th>
                <td>: {{ \Carbon\Carbon::parse($acara->project->akhir)->translatedFormat('d F Y') }}</td>
            </tr>
        </table>
        ...
        <div class="signatures">
            <div class="sig">
                ...
                <div class="role">
                    {{ $acara->project->corporate?->nama ?? $acara->project->perorangan?->first()->nama }}</div>
                <div class="name">{{ $acara->project->perorangan?->first()->nama }}</div>
            </div>
